...
const generateRemark = (index, port) => {
    ...
    switch (index) {
        case 0:
        case 1:
            remark = `⚡️VIP - Domain_${index + 1} : ${port}`;
            break;
        case 2:
        case 3:
            remark = `⚡️VIP - IPv4_${index - 1} : ${port}`;
            break;
        case 4:
        case 5:
            remark = `⚡️VIP - IPv6_${index - 3} : ${port}`;
            break;
        default:
            remark = `⚡️VIP - Clean IP_${index - 5} : ${port}`;
            break;
    }
...
const buildWorkerLessConfig = async (env, client) => {
    ...
    fragConfig.remarks  = '⚡️VIP Frag - WorkerLess ⭐'
...
const getFragmentConfigs = async (env, hostName, client) => {
    ...
    bestPing.remarks = '⚡️VIP Frag - Best Ping 💥';
    ...
    bestFragment.remarks = '⚡️VIP Frag - Best Fragment 😎';
...
const getWarpConfigs = async (env, client) => {
    ...
    xrayWoWConfig.remarks = '⚡️VIP - WoW 🌍';
    ...
    warpEndpoints.split(',').forEach((endpoint, index) => {
        ...
        xrayWarpConfig.remarks = `⚡️VIP - Warp ${index + 1} 🇮🇷`;
    ...
    xrayWarpBestPing.remarks = '⚡️VIP - Warp Best Ping 🚀';
